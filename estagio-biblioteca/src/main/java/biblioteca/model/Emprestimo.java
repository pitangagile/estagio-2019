...
@Entity
@Table(name = "tbemprestimo", schema = "biblioteca")
public class Emprestimo implements IObjectPersistent<Long> {
    ...
    @JoinTable(name = "tb_emprestimo_livro", joinColumns = @JoinColumn(name = "emp_cl_id"), inverseJoinColumns = @JoinColumn (name = "liv_cl_id"), schema = "biblioteca")
